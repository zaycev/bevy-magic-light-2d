...
impl AssetUtil
{
    ...
    {
        AssetPath::parse("gi/target".into()).with_label(l.to_owned())
    }
    pub fn camera(l: &'static str) -> AssetPath
    {
        AssetPath::parse("camera/target".into()).with_label(l.to_owned())
    }
    pub fn material(l: &'static str) -> AssetPath
    {
        AssetPath::parse("material".into()).with_label(l.to_owned())
    }
    pub fn mesh(l: &'static str) -> AssetPath
    {
        AssetPath::parse("mesh".into()).with_label(l.to_owned())
    }
}
